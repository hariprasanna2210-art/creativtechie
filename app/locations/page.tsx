...
export const metadata: Metadata = {
  ...
  description:
    "CreativTechie serves Puducherry, Pondicherry and Tamil Nadu businesses with web design, SEO, digital marketing, branding and AI automation.",
      ...
      <section className="mesh-bg py-10">
        <div className="container pb-20">
          ...
          <h1 className="mt-4 max-w-4xl font-display text-4xl font-black leading-tight md:text-6xl">
            Digital agency services for Puducherry, Pondicherry and Tamil Nadu.
          </h1>
          <p className="mt-6 max-w-3xl text-xl leading-9 text-[#34495e]">
            We help local business owners improve search visibility, trust, enquiry quality and digital operations with clear websites, SEO systems and AI-ready content.
          </p>
        </div>
      </section>
